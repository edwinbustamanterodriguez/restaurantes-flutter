...
class Restaurant {
  ...
  factory Restaurant.fromJson(Map<String, dynamic> json) => Restaurant(
    ...
    logo: json["logo"]??"https://upload.wikimedia.org/wikipedia/commons/e/ef/Restaurant_N%C3%A4sinneula.jpg",
    rating: json["rating"],
  ...
  static List<Restaurant> listFromJson(list) => List<Restaurant>.from(list.map((x) => Restaurant.fromJson(x)));
}
